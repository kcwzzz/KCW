...
/*
bool CRyuNodeList::IsBe(SPathInfo *tpPathInfo)
{
...
SPathInfo *CRyuNodeList::IsBe(SPathInfo *tpPathInfo)
{
...
SPathInfo *CRyuNodeList::FindPathInfoList(SPathInfo *tpPathInfo)
{
...
SRyuNode *CRyuNodeList::OrderedInsert(SPathInfo *tpPathInfo)
{
    SRyuNode *s = NULL;
    SRyuNode *p = NULL;
...
void CRyuNodeList::SetLocation(SPathInfo *tpPathInfo)
{
    SPathInfo *tmp = NULL;
...
bool CRyuNodeList::DeletePathInfo(SPathInfo *tpPathInfo)
{	
    SRyuNode *s = NULL;
    SRyuNode *p = NULL;

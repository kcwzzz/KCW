...
Scene* CSceneWheelJt::createScene()
{
    auto scene = Scene::create();
    
    auto layer = CSceneWheelJt::create();
...
bool CSceneWheelJt::init()
{
    ...
    auto tBtnClose = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(CSceneWheelJt::OnClickBtnGoScene, this));
    ...
    {
        this->schedule(schedule_selector(CSceneWheelJt::tick));
    }
...
bool CSceneWheelJt::createBox2dWorld(bool debug)
{
    // 월드 생성 시작 --------------------------------------------------------------------------
...
CSceneWheelJt::~CSceneWheelJt()
{
    delete _world;
    _world = NULL;
}

void CSceneWheelJt::draw(Renderer *renderer, const Mat4& transform, uint32_t flags)
{
    //
    // IMPORTANT:
...
void CSceneWheelJt::tick(float dt)
{
...
b2Body* CSceneWheelJt::addNewSprite(Point point, Size size, b2BodyType bodytype,
...
void CSceneWheelJt::OnClickBtnGoScene(cocos2d::Ref* pSender)
{

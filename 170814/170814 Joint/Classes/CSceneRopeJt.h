#ifndef __CSceneRopeJt_SCENE_H__
#define __CSceneRopeJt_SCENE_H__
...
class CSceneRopeJt : public cocos2d::Layer
{
public:
...
#endif // __CSceneRopeJt_SCENE_H__

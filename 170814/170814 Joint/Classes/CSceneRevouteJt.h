#ifndef __CSceneRevouteJt_SCENE_H__
#define __CSceneRevouteJt_SCENE_H__
...
class CSceneRevouteJt : public cocos2d::Layer
{
public:
...
#endif // __CSceneRevouteJt_SCENE_H__

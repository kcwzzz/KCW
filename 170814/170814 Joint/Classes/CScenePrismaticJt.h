#ifndef __CScenePrismaticJt_SCENE_H__
#define __CScenePrismaticJt_SCENE_H__
...
class CScenePrismaticJt : public cocos2d::Layer
{
public:
...
#endif // __CScenePrismaticJt_SCENE_H__

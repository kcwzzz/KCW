#ifndef __CSceneWeldJt_SCENE_H__
#define __CSceneWeldJt_SCENE_H__
...
class CSceneWeldJt : public cocos2d::Layer
{
public:
...
#endif // __CSceneWeldJt_SCENE_H__

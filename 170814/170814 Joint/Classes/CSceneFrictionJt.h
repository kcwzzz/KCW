#ifndef __CSceneFrictionJt_SCENE_H__
#define __CSceneFrictionJt_SCENE_H__
...
class CSceneFrictionJt : public cocos2d::Layer
{
public:
...
#endif // __CSceneFrictionJt_SCENE_H__

...
Scene* CSceneGearJt::createScene()
{
    auto scene = Scene::create();
    
    auto layer = CSceneGearJt::create();
...
bool CSceneGearJt::init()
{
    ...
    auto tBtnClose = MenuItemImage::create(
                                           "CloseNormal.png",
                                           "CloseSelected.png",
                                           CC_CALLBACK_1(CSceneGearJt::OnClickBtnGoScene, this));
    ...
    {
        this->schedule(schedule_selector(CSceneGearJt::tick));
    }
...
bool CSceneGearJt::createBox2dWorld(bool debug)
{
    // 월드 생성 시작 --------------------------------------------------------------------------
...
CSceneGearJt::~CSceneGearJt()
{
    delete _world;
    _world = NULL;
}

void CSceneGearJt::draw(Renderer *renderer, const Mat4& transform, uint32_t flags)
{
    //
    // IMPORTANT:
...
void CSceneGearJt::tick(float dt)
{
...
b2Body* CSceneGearJt::addNewSprite(Point point, Size size, b2BodyType bodytype,
...
void CSceneGearJt::OnClickBtnGoScene(cocos2d::Ref* pSender)
{

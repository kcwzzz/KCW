#ifndef __CSceneMouseJt_SCENE_H__
#define __CSceneMouseJt_SCENE_H__
...
class CSceneMouseJt : public cocos2d::Layer
{
public:
...
#endif // __CSceneMouseJt_SCENE_H__

#ifndef __CScenePulleyJt_SCENE_H__
#define __CScenePulleyJt_SCENE_H__
...
class CScenePulleyJt : public cocos2d::Layer
{
public:
...
#endif // __CScenePulleyJt_SCENE_H__
